...
namespace RandomFromDistributions
{
    public static class RandomFromDistribution
    {
        ...
        private static readonly float[] confidence_to_z_score =
        {
            0.84162123f,
            1.28155156f,
            1.64485363f,
        ...
        public static float RandomFromSlopedDistribution(float skew, Direction_e direction)
        {
            ...
            if (direction == Direction_e.Left) value = 1.0f - value;
        ...
        {
            if (slope == 0) return Random.Range(0.0f, 1.0f);
        ...
        public static float RandomFromExponentialDistribution(float exponent, Direction_e direction)
        {
            ...
            if (direction == Direction_e.Left) x_val = 1.0f - x_val;
